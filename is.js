        ...
        is.obj = function(value) {return typeof value === 'object' && !is.arr(value) && value != null;}
        is.fun = function(value) {return typeof value == "function"}
        is.truthy = function(value) {return Boolean(value)}
        is.falsy = function(value) {return !Boolean(value)}